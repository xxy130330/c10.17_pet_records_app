...
export function updateSessions(id,auth, logout,vetAccess){
...
//****** POST vet log in ********/
const vet_login_url = "/server/database_connect/server.php?action=post&resource=vetlogin";
...
//****** POST register vet ********/
const vet_register_url = "/server/database_connect/server.php?action=post&resource=registerVet";
